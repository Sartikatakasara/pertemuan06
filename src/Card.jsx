function Card() {
    return (
        <>
            <div class="flex justify-center items-center h-screen w-full bg-gradient-to-r from-purple-500 to-orange-600">
                <div class="w-1/2 bg-white rounded-lg shadow-2xl p-8 m-4">
                    ...
                    <form action="/" method="post">
                        <div class="flex flex-col mb-4">
                            ...
                            <div class="flex flex-col mb-4">
                              <label
                              class="mb-2 font-bold text-lg text-purple-900"
                              for="gender"
                              >
                                Gender
                              </label>
                              <div>
                                <input
                                class="border py-2 font-bold text-purple-800"
                                type="radio"
                                name="gender"
                                id="pria"
                                />
                                <label
                                class="mb-2 text-purple-900"
                                for="pria"
                                >pria</label>
                                </div>
                                <div>
                                    <input
                                        class="border py-2 px-3 text-purple-800"
                                        type="wanita"
                                        for="gender"
                                        id="wanita"
                            />
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <select
                            class="border py-2 -py-3 text-purple-800"
                            name="agama"
                            id="agama"
                        >
                          ...
                          <option value="Kepercayaan">Aliran kepercayaa</option>
                        </select>
                    </div>
                    <button
